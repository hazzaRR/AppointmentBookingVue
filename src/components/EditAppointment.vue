        ...
        <form v-if="editModalDisplay === 'editDisplay'" method="dialog">
                    ...
                    <a @click="switchDisplay('treatmentsDisplay')" class="flex items-center justify-center w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-blue-500 rounded-lg shrink-0 sm:w-auto gap-x-2 hover:bg-blue-600 dark:hover:bg-blue-500 dark:bg-blue-600">
                        ...
                        <div class="mt-4 sm:flex sm:items-center sm:-mx-2">
                            ...
                            <button @click="updateAppointment(appointment)"  class="w-full px-4 py-2 mt-3 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-600 rounded-md sm:mt-0 sm:w-1/2 sm:mx-2 hover:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40">
                                Update
                            </button>
...
const paymentTypes = [null, "cash", "card", "voucher"];
...
watch(() => props.appointmentDetails, (newAppointmentDetails, oldAppointmentDetails) => {
    ...
    appointment.value = JSON.parse(JSON.stringify(newAppointmentDetails));
});
...
onMounted(() => {
    ...
    appointment.value = JSON.parse(JSON.stringify(props.appointmentDetails));
})
